...
namespace DijkstraTest2
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object creator, EventArgs e) //Goi ten cac dia diem va set vi tri
        {
            ...
            Location TayNinh = new Location("Tây Ninh", "B", 431, 105);
            Location SaiGon = new Location("TP.Hồ Chí Minh", "C", 502, 164);
            ...
            g.InsertEdge("TP.Hồ Chí Minh", "Bình Phước", 124);
            g.InsertEdge("Vũng Tàu", "TP.Hồ Chí Minh", 98);
            g.InsertEdge("Tiền Giang", "TP.Hồ Chí Minh", 72);
            g.InsertEdge("An Giang", "TP.Hồ Chí Minh", 235);
            g.InsertEdge("Tây Ninh", "TP.Hồ Chí Minh", 92);
            g.InsertEdge("Trà Vinh", "TP.Hồ Chí Minh", 125);
        ...
        private void DrawLine() // Noi cac tuyen duong co the di duoc va da tinh toan chi phi
        {
            ...
            DrawLine("TP.Hồ Chí Minh", "Bình Phước");
            DrawLine("Vũng Tàu", "TP.Hồ Chí Minh");
            DrawLine("Tiền Giang", "TP.Hồ Chí Minh");
            DrawLine("An Giang", "TP.Hồ Chí Minh");
            DrawLine("Tây Ninh", "TP.Hồ Chí Minh");
            DrawLine("Trà Vinh", "TP.Hồ Chí Minh");
